...
public class ViewUtils {
     ...
     * @return a circle drawable with the color provided by colorId
     */
    public static Drawable getColoredCircleDrawableById(final Context context, int colorId)
    {
    ...
    public static int[] getCustomColorsArray(Context context)
    {
        ...
        for (int i = 0; i < colorsTypedArray.length(); i++) {
            colors[i] = colorsTypedArray.getColor(i, 0);
        }
